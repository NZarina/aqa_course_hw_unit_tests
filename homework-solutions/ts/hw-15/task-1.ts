...
const car = new Car('BMW', '3.0 CSL Hommage', 2020);
console.log(car.make) // BMW
console.log(car.getDetails()); // BMW 3.0 CSL Hommage, 2020
console.log(car.start()); // The vehicle BMW 3.0 CSL Hommage is starting.