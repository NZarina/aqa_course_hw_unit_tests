...
function customMapFunction<T, U>(
    array: T[],
...
const elementMuptipliedByIndex = customMapFunction([1,2,3,4,5], (element, index) => element * index);
console.log(elementMuptipliedByIndex); // [ 0, 2, 6, 12, 20 ]